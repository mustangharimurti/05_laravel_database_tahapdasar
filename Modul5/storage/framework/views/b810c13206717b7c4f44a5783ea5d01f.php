                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <label for="firstName" class="form-label">First
                            Name</label>
                        <h5><?php echo e($employee1->firstname); ?></h5>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="lastName" class="form-label">Last
                            Name</label>
                        <h5><?php echo e($employee1->lastname); ?></h5>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="email" class="form-label">Email</label>
                        <h5><?php echo e($employee1->email); ?></h5>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="age" class="form-label">Age</label>
                        <h5><?php echo e($employee1->age); ?></h5>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="age" class="form-label">Position</label>
                        <h5><?php echo e($employee1->position_name); ?></h5>
                    </div>
                </div>
                <hr>
                <div class="row">
...
<?php /**PATH C:\Users\Muhamad Brilliant\modul4\resources\views/employee/show.blade.php ENDPATH**/ ?>